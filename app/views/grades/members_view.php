...
<tr class="color-data-table">
  ...
  <a class="dropdown-item" href="../students_grades/create.php?id='.$row['id_alumno'].'&from=2"><span><img src="../../web/img/iconos/edit.png" width="25px"><span/><span class="ml-3">Opciones de grado</span></a>
  </div>
</div>
    </td>
</tr>
