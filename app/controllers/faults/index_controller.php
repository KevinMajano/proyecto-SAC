...
try{
	...
	if(isset($_POST['buscar'])){
        ...
        $data = $faults->searchFalta($_POST['nombre']);
		if($data){
	...
	if($data){
		require_once("../../app/views/faults/index_view.php");
	}else{
		Page::showMessage(3, "No hay Faltas disponibles", "create.php");
	}
