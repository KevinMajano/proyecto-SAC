	...
	if(isset($_GET['id'])){
		...
		if($faults->setId($_GET['id'])){
			...
			if($faults->readFalta()){
				...
				throw new Exception("Falta inexistente");
			}
		}else{
...
require_once("../../app/views/faults/delete_view.php");
?>